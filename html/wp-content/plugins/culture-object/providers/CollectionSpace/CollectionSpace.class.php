...
//            'fieldColEventName' => 'Field Collection Event Name'
    ...
    function update_collectionspace_object($post,$object) {
        ...
        if (isset($object['collectionobjects_common']['distinguishingFeatures']))
            update_post_meta($post->ID,'distinguishingFeatures', $this->unarray($object['collectionobjects_common']['distinguishingFeatures']));
        if (isset($object['collectionobjects_common']['numberOfObjects']))
            update_post_meta($post->ID,'numberOfObjects', $this->unarray($object['collectionobjects_common']['numberOfObjects']));
